...
const colorize = {
    ...
    // Méthodes pour les logs colorisés
...
async function colorLoggerPlugin(fastify) {
    // Étendre fastify.log avec des méthodes colorisées
    ...
    // Optionnel : décorer aussi avec les utilitaires de couleur brutes
    // fastify.decorate('colors', colors)
    // fastify.decorate('colorize', colorize)
}
