import { register, selectUsers, unregister, login, logout, refreshAccessToken, getUserProfile, accessProfileInfo, changeDoubleAuth, verifyDoubleAuth, activateDoubleAuth, changeProfilePicture, changeProfile, refreshInfos} from '../controllers/authController.js';
