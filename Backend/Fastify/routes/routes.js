import { register, selectUsers, unregister, login, logout, changeDoubleAuth, changeRole, refreshAccessToken, getUserProfile, generate_doubleAuth } from '../controllers/authController.js';
